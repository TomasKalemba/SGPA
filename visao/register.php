                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="../controlo/login.php" enctype="multipart/form-data" id="createAccountForm">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="nomeUsuario" name="nomeUsuario" type="text" placeholder="Digite seu nome completo" required
                            ...
                            <!-- E-mail -->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="emailUsuario" name="emailUsuario" type="email" placeholder="name@example.com" required
...
function montarCamposExtras(tipo) {
    ...
    if (tipo === "Estudante") {
        ...
        camposExtras.innerHTML = `
            <div class="form-floating mb-3">
                <input class="form-control" id="numeroMatricula" name="numeroMatricula" type="text" placeholder="Digite o número de matrícula" required maxlength="6" value="${oldMatricula}" />
                <label for="numeroMatricula"><i class="fas fa-id-card"></i> Número de Matrícula</label>
            </div>
            ...
            <div class="form-floating mb-3">
                ...
                <label for="curso_id"><i class="fas fa-graduation-cap"></i> Curso</label>
            </div>

            <div class="form-floating mb-3">
                <select class="form-select" id="ano_curricular" name="ano_curricular" required>
                ...
                <label for="ano_curricular"><i class="fas fa-calendar-alt"></i> Ano Curricular</label>
            </div>
        `;
...
// Garantir que overlay está oculto ao carregar
window.addEventListener('load', () => {
  document.getElementById('overlayProcessando').style.display = 'none';
});

// Mostrar overlay processando ao enviar, mas só se passar as validações
document.getElementById('createAccountForm').addEventListener('submit', function(e) {
    // Exemplo de validação extra: senhas iguais
    const senha = document.getElementById('inputPassword').value;
    const senhaConfirm = document.getElementById('inputPasswordConfirm').value;
