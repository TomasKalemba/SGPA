...
// Aqui fazemos JOIN para buscar o nome do curso
$stmt = $conn->prepare("
    SELECT u.foto, u.numero_matricula, u.ano_curricular, 
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-lg border-0 rounded-lg mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="../controlo/EditarPerfilAluno.php" enctype="multipart/form-data" id="createAccountForm">
                                    <input type="hidden" name="EditarPerfilAluno" value="EditarPerfilAluno">
                                    ...
                                    <?php if ($_SESSION['tipo'] == 'Estudante'): ?>
                                        <!-- Matrícula -->
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputMatricula" name="numero_matricula" type="text" 
                                                value="<?= htmlspecialchars($usuario['numero_matricula'] ?? '') ?>" />
                                            <label for="inputMatricula"><i class="fas fa-id-card"></i> Matrícula</label>
                                        </div>

                                       <!-- Curso -->
<div class="form-floating mb-3">
    <input class="form-control" id="inputCurso" name="curso_nome" type="text" 
        value="<?= htmlspecialchars($usuario['curso_nome'] ?? '') ?>" readonly />
    <label for="inputCurso"><i class="fas fa-graduation-cap"></i> Curso</label>
</div>

                                        <!-- Ano Curricular -->
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputAnoCurricular" name="ano_curricular" type="number" min="1" max="6"
                                                value="<?= htmlspecialchars($usuario['ano_curricular'] ?? '') ?>" />
                                            <label for="inputAnoCurricular"><i class="fas fa-calendar"></i> Ano Curricular</label>
                                        </div>
                                    <?php endif; ?>
