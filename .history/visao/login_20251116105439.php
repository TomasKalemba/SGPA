      ...
      <div style="width: 100%; display: flex; flex-direction: column; align-items: center;">
        ...
        <?php if (isset($_SESSION['mensagem']) && !empty($_SESSION['mensagem'])): ?>
          <?php
            ...
            $alert = 'danger';
            if (str_contains(strtolower($mensagem), 'sucesso')) $alert = 'success';
            elseif (str_contains(strtolower($mensagem), 'aguarde')) $alert = 'warning';
          ?>
          <div class="alert alert-<?= $alert ?> alert-dismissible fade show" role="alert" style="width:100%; max-width:400px;">
