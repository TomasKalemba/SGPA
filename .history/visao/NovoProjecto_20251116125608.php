...
<head>
    ...
    <style>
        ...
        /* Estilo da mensagem de processamento */
        #processando {
            display: none;
            margin-bottom: 15px;
            color: #0d6efd;
...
<div id="layoutSidenav_content">
    <div class="container">
        <div class="form-container">
            ...
            <div id="processando">
                <i class="fas fa-spinner fa-spin"></i> Processando, aguarde...
            </div>

            <form action="../controlo/novoprojecto.php" method="POST" enctype="multipart/form-data" id="formProjeto">
                ...
                <div class="text-center">
                    <button type="submit" id="btnEnviar" class="btn btn-primary px-5">
...
<!-- Script para mostrar "Processando..." -->
<script>
