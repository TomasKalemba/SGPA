...
<div class="container">
    <div class="form-container">
        ...
        <form action="../Controlo/EditarProjecto.php" method="POST" enctype="multipart/form-data" class="mt-4">
            ...
            <!-- Docente -->
            <div class="form-group mb-3">
                <label for="docente_id"><i class="fas fa-chalkboard-teacher"></i> Docente Responsável</label>
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="estudantes" name="estudantes[]" multiple="multiple" style="width: 100%;">
