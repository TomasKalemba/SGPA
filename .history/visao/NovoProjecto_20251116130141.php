...
<div id="layoutSidenav_content">
    <div class="container">
        <div class="form-container">
            ...
            <form id="formProjeto" action="../controlo/novoprojecto.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center">
                    <button id="btnEnviar" class="btn btn-primary px-5"><i class="fas fa-plus-circle"></i> Criar Projeto</button>
                </div>
            </form>
        </div>
    </div>
...
// Mostrar overlay quando enviar form
document.getElementById('formProjeto').addEventListener('submit', function(e) {
    document.getElementById('processando').style.display = 'flex';  // mostra overlay
    document.getElementById('btnEnviar').disabled = true; // desabilita botão para evitar múltiplos envios
});
</script>
