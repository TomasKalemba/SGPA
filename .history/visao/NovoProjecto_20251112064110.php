            ...
            <form action="../controlo/novoprojecto.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" class="form-control" name="arquivo" accept=".pdf,.docx,.pptx,.jpg,.png">
                    </div>
                </div>
                ...
                <div class="text-center">
                    <button class="btn btn-primary px-5"><i class="fas fa-plus-circle"></i> Criar Projeto</button>
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#estudantes').select2({
        ...
        language: {
            inputTooShort: () => "Digite pelo menos 1 letra...",
            noResults: () => "Nenhum estudante encontrado",
            searching: () => "Buscando..."
        }
    });
