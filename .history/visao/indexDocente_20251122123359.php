...
<div id="layoutSidenav_content">
    <main class="py-4" style="background-color: #f4f7fa;">
            ...
            <div class="row g-3 mb-4 text-center">
                ...
                foreach ($cards as $c) {
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <div class="card text-white shadow-sm" style="background-color: {$c['bg']}; cursor:pointer;" data-tipo="{$c['id']}">
                            <div class="card-body py-3">
                                <i class="bi bi-{$c['icon']}" style="font-size: 1.5rem;"></i>
                                <h6 class="mt-2" style="font-size: 0.9rem;">{$c['label']}</h6>
                                <h4 id="{$c['id']}" style="font-size: 1.3rem; margin:0;">0</h4>
                            </div>
                        </div>
                    </div>
                    HTML;
