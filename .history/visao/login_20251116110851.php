...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* OVERLAY PROCESSANDO */
    #overlayProcessando {
      display: none; /* Mantido oculto no início */
      position: fixed;
...
<script>
  // Garantir overlay escondido ao carregar
  window.addEventListener('load', () => {
    document.getElementById('overlayProcessando').style.display = 'none';
  });

  document.getElementById('loginForm').addEventListener('submit', function(e) {
    // Opcional: validar campos aqui antes de mostrar overlay

    // Mostrar overlay somente após o submit
