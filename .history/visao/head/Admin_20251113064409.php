...
<html lang="pt">
   ...
   /* Fundo escuro e efeito de transição */
/* Fundo apenas para escurecer atrás do modal */
#searchResults {
    position: fixed;
    top: 0;
    left: 0;
...
#resultsContainer {
    ...
    max-height: 80vh; /* altura máxima menor */
    overflow-y: auto;
    margin: auto;
    position: absolute;
    top: 50%;
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="ActivarConta.php"><i class="fas fa-plus-circle text-info"></i> Activar Contas</a> <!-- Cor azul -->
                                <a class="nav-link" href="EliminarEstudante.php"><i class="fas fa-plus-circle text-info"></i>  Estudantes</a> <!-- Cor azul -->
                                    ...
                                    <a class="nav-link" href="VerProjectos.php"><i class="fas fa-eye text-info"></i> Ver Projectos</a> <!-- Cor azul -->
                                    <a class="nav-link" href="EnviarProjecto.php"><i class="fas fa-upload text-success"></i> Enviar Projecto</a> <!-- Cor verde -->
                                    <a class="nav-link" href="SubmissoesA.php"><i class="fas fa-paper-plane text-warning"></i> Projectos Enviados</a> <!-- Cor amarela -->
                                </nav>
                            </div>
