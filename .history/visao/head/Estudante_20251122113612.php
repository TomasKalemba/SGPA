...
window.onpopstate = function () {
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a href="indexEstudante.php" class="btn btn-outline-light btn-sm me-3" title="Voltar ao Home">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="indexEstudante.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt text-primary"></i></div>Home
                        </a>
                        <div class="sb-sidenav-menu-heading"><?=$_SESSION['tipo']?></div>
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false">
                            <div class="sb-nav-link-icon"><i class="fas fa-columns text-success"></i></div>Meus Projectos
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchForm.addEventListener('submit', function(e) {
        ...
        fetch(`search.php?query=${encodeURIComponent(query)}`)
            ...
            .finally(() => {
                btnNavbarSearch.disabled = false;
            });
    });
