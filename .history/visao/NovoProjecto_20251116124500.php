...
<div id="overlayProcessando">
  ...
  <div>Processando criação do projeto, por favor aguarde...</div>
</div>
...
<script>
  // Mostrar overlay "Processando..." ao enviar o formulário
  document.getElementById('formNovoProjeto').addEventListener('submit', function () {
    document.getElementById('overlayProcessando').style.display = 'flex';
  });

  // Garantir que overlay está escondido ao carregar a página
