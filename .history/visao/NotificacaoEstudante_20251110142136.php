...
try {
    ...
    $stmtNaoLidas = $conn->prepare("
        ...
        WHERE ge.estudante_id = :ge_estudante_id
          AND n.estudante_id = :n_estudante_id
          AND (LOWER(n.status) = 'não lida' OR LOWER(n.status) = 'nao lida')
          AND n.mensagem LIKE 'Você foi atribuído%'
    ");
    $stmtNaoLidas->execute([
        'ge_estudante_id' => $estudante_id,
        'n_estudante_id' => $estudante_id
    ]);
...
$whereClauses = ["ge.estudante_id = :ge_estudante_id", "n.estudante_id = :n_estudante_id", "n.mensagem LIKE 'Você foi atribuído%'"];
$params = [
    'ge_estudante_id' => $estudante_id,
    'n_estudante_id' => $estudante_id
];
