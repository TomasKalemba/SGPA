        ...
        <div class="form-container">
            ...
            <form action="../Controlo/EditarProjecto.php" method="POST" enctype="multipart/form-data" class="mt-4">
                ...
                <?php if ($_SESSION['tipo'] === 'Admin'): ?>
                    <!-- Select de estudantes existentes (remover) -->
                    <div class="form-group mb-3">
                        <label for="estudantes_existentes"><i class="fas fa-users"></i> Estudantes do Projeto</label>
                        <select id="estudantes_existentes" name="estudantes[]" class="form-control" multiple="multiple">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="novos_estudantes" name="novos_estudantes[]" class="form-control" multiple="multiple"></select>
...
$(document).ready(function() {
    <?php if ($_SESSION['tipo'] === 'Admin'): ?>
    // Select de estudantes existentes
