...
<head>
  ...
  <style>
    /* Seu CSS para campos arredondados, cores e layout */
    /* ... pode copiar seu CSS do login aqui ... */
    body {
...
<div class="login-container">
  ...
  <form id="loginForm" method="post" action="../controlo/login.php">
    ...
    <div class="input-group">
      ...
      <input type="email" name="email" id="email" placeholder="Usuário" required autocomplete="off" value="<?= htmlspecialchars($old_email) ?>">
    </div>

    <div class="input-group">
      <i class="fas fa-lock"></i>
      <input type="password" name="senha" id="senha" placeholder="Senha" required autocomplete="off" style="padding-left: 40px; padding-right: 40px;">
