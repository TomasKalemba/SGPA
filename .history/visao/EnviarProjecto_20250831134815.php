...
// Buscar projetos atribuídos ao estudante (com descrição e prazo)
$projetos = [];
    ...
    <form method="post" action="../controlo/EnviarProjecto.php" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label class="form-label">
                <i class="fas fa-project-diagram"></i> Projeto Atribuído
            </label>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="descricaoProjeto" name="descricao" rows="3" readonly required></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="prazoProjeto" name="data_submissao" readonly required>
        </div>
...
<!-- Script para preencher campos ao selecionar projeto -->
<script>
document.getElementById('projetoSelect').addEventListener('change', function () {
    ...
    document.getElementById('prazoProjeto').value = prazo || '';
});
</script>
</script>
