...
<script>
    $(document).ready(function() {
        ...
        function atualizarTabelaProjetos() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Inicializa DataTable para filtros, pesquisa e exportação
                    $('#tabelaProjetos').DataTable({
                        dom: '<"row"<"col-sm-6"l><"col-sm-6"f>>tipr', // Layout para barra de pesquisa à direita e controle de exibição de registros
                        buttons: [
                            {
                        ...
                        language: {
                            search: "Pesquisar:", // Texto do campo de pesquisa
                            lengthMenu: "Mostrar _MENU_ registros", // Texto para a quantidade de registros por página
                            info: "Mostrando _START_ a _END_ de _TOTAL_ registros", // Texto para exibição do intervalo de registros
                            infoEmpty: "Nenhum registro encontrado", // Texto quando não há registros
                            zeroRecords: "Nenhum registro correspondente encontrado", // Texto quando não há correspondência na pesquisa
                            paginate: {
                                first: "Primeiro", // Texto para o botão de "primeiro"
                                last: "Último", // Texto para o botão de "último"
                        ...
                        lengthChange: true, // Habilita a mudança de número de registros por página
        ...
        // Chama a função de atualização da tabela
