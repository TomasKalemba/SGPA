...
class VerProjectos extends crud {
    ...
    public function getAllProjectsAtivos() {
        $sql = "SELECT ... FROM projectos p WHERE p.estado = 1 ...";  // igual ao getAllProjects, mas com filtro estado=1
        // resto igual
    }
    
    public function getProjetosPorDocenteAtivos($docenteId) {
        $sql = "SELECT ... FROM projectos p WHERE p.docente_id = ? AND p.estado = 1 ...";
        // resto igual
    }
    
    public function getProjetosPorEstudanteAtivos($estudanteId) {
        $sql = "SELECT ... WHERE ge.estudante_id = ? AND p.estado = 1 ...";
        // resto igual
    }
