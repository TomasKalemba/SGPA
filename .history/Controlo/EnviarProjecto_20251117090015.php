...
$mensagemDocente = "O estudante {$nome_estudante} submeteu o projeto com Titulo \"{$titulo}\".";
...
if ($result) {
    ...
    $mensagem = "Você foi atribuído a um novo <strong>Projeto:</strong> $titulo  <strong>Prazo:</strong> $prazo  <strong>Descrição:</strong> $descricao";
