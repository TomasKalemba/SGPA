...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($grupo) {
            ...
            $new_students = array_map('intval', $estudantes);

            // Remove estudantes que não estão na nova lista
            $students_to_remove = array_diff($current_students, $new_students);
            ...
            $students_to_add = array_diff($new_students, $current_students);
